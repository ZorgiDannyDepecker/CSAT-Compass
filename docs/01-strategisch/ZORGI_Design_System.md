...
![ZORGI Heartbeat Icon (White)](Logo-icoon_144_x_144_px_wit.png)
...
> **Usage in code:** When building tools, dashboards, or artifacts, reference this file as the favicon or header icon. For HTML/React artifacts, use it as an `<img>` tag or background image on dark-colored headers.
...
border-radius: 0 40px 0 0;  /* example: top-right only */
```
...
## 10. Quick Reference — CSS Variables for Web/App Development
